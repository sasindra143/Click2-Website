...
const SERVICES = [
  {
    ...
    desc: 'Secure portals with real-time appointment booking, doctor directories, and patient history.',
    bullets: ['Appointment Systems', 'Patient Portals', 'Doctor Directories', 'HIPAA Compliant Architecture'],
    color: 'purple',
    img: '/ai-images/service_hospital_1774054662684.png',
  },
  {
    icon: '🏫',
    title: 'College Portals',
    desc: 'Dynamic educational websites for seamless student-faculty management.',
    bullets: ['Admission Portals', 'Notice Boards', 'Result Processing', 'Alumni Networks'],
    color: 'blue',
    img: '/ai-images/service_college_1774054683400.png',
  },
  {
    icon: '💼',
    title: 'Business Websites',
    desc: 'High-conversion corporate platforms designed to capture leads and boost SEO.',
    bullets: ['Lead Generation', 'Fast Loading', 'SEO Optimized', 'CRM Form Integrations'],
    color: 'green',
    img: '/ai-images/service_business_1774054704656.png',
  },
  {
    icon: '🎓',
    title: 'LMS Web Platforms',
    desc: 'Complete Learning Management Systems for courses and certifications.',
    bullets: ['Video Course Hosting', 'Quizzes & Grading', 'Secure Payments', 'Certificate Generation'],
    color: 'amber',
    img: '/ai-images/service_college_1774054683400.png', // Fallback to college UI
  },
];
